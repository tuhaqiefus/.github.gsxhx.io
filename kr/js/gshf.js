    ...
    const headerHtml = `
        ...
        <header class="主页眉" id="主页眉">
            <div class="页眉内容">
                ...
                <div class="页眉列 btn"><a class="页眉按钮" href="https://www.bilibili.com" target="_blank">公司介绍</a></div>
                <div class="页眉列 btn"><a class="页眉按钮" href="https://www.bilibili.com" target="_blank">工程业绩</a></div>
                <div class="页眉列 btn"><a class="页眉按钮" href="https://www.bilibili.com" target="_blank">可持续发展</a></div>
                <div class="页眉列 btn"><a class="页眉按钮" href="https://www.bilibili.com" target="_blank">科技研发</a></div>
                <div class="页眉列 btn"><a class="页眉按钮" href="https://www.bilibili.com" target="_blank">新闻资讯</a></div>
            </div>
        </header>
        ...
        <div class="页眉下拉弹窗" id="页眉下拉弹窗">
            <div class="下拉弹窗内容">
                ...
                <div class="下拉弹窗列 btn">
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">愿景</a>
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">发展历程</a>
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">关联公司</a>
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">组织架构</a>
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">荣誉资质</a>
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">业务伙伴</a>
                </div>
                <div class="下拉弹窗列 btn">
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">洁净系统</a>
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">微电子</a>
                </div>
                <div class="下拉弹窗列 btn">
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">可持续发展</a>
                </div>
                <div class="下拉弹窗列 btn">
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">设备研发</a>
                </div>
                <div class="下拉弹窗列 btn">
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">宣传中心</a>
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">宣传片</a>
                    <a class="下拉弹窗子按钮" href="https://www.bilibili.com" target="_blank">溶酶体</a>
                </div>
            </div>
        </div>
    `;
...
function initHeaderFooter() {
    ...
    // 假设的图片路径数组
    const 提示图片路径s = [
        '../cn/assets/images/css/css1.jpg',
      '../cn/assets/images/css/css2.jpg',
     '../cn/assets/images/css/css3.jpg',
      '../cn/assets/images/css/css4.jpg',
     '../cn/assets/images/css/css5.jpg'
